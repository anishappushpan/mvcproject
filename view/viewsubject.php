					...
					<div class="col-md-12">
						<table class="border table table-striped bg-table">
							<?php 
								...
								$result=$obj->Studentsubject($_SESSION['year']);
							...
							<tr>
							<td class="font-weight-bolder">Code</td>
							<td><?php echo $row['code'];?></td>
							</tr>
							
							<tr>
							<td class="font-weight-bolder">Semester</td>
							...
							<tr>
							<td class="font-weight-bolder">Creadit</td>
