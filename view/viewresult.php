...
<section >
				<div class="container">
					<div class="row border ">
						<div class="col-md-6">
							<h3 class="text-primary head"><i class="fas fa-user fa-2x" ></i>Curriculum</h3>
					...
					<div class="col-md-12">
						<table class="border table table-striped bg-table">
							<?php 
								...
								$result=$obj->Studentresult($_SESSION['name']);
							...
							<tr>
							<td class="font-weight-bolder">Register Number</td>
							<td><?php echo $row['regno'];?></td>
							</tr>
							
							<tr>
							<td class="font-weight-bolder">Index Number</td>
							<td><?php echo $row['indexno'];?></td>
							</tr>
							
							<tr>
							<td class="font-weight-bolder">Course Code</td>
							...
							<tr>
							<td class="font-weight-bolder">Result</td>
							<td><?php echo $row['result'];?></td>
							</tr>
							
							<tr>
							<td class="font-weight-bolder">Credit</td>
							<td><?php echo $row['credit'];?></td>
							</tr>
							
							<tr>
							<td class="font-weight-bolder">Total CGPA</td>
							<td><?php echo $row['totalcgpa'];?></td>
							</tr>
							<?php
								}		
							?>
